...
// See https://github.com/dpena-cb/githubv4/issues/9 for details.
//
...
// can be used for unmarshaling. Once https://github.com/dpena-cb/githubv4/issues/9
...
func NewJsonBlob(v map[string]string) *map[string]string { return &v }
